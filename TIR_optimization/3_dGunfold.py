...
# AUG_indexes =[[] for i in range(len(f))]
AUG_indexes_2 =[]

for i in range(0, len(fields), 1):
    AUG_indexes_2.append(fields[i])
...
for i, j in enumerate(index_pairs):
    ...
    for k, l in enumerate(j):
        ...
        if int(l[1]) == 0:
            fields2[i][k] = "x"
        if int(l[1]) != 0 and int(l[0]) < int(l[1]) and (int(l[0]) < int(AUG_indexes_2[i])-RBS_window)                                                    and     (int(l[1]) < int(AUG_indexes_2[i])-RBS_window or int(l[1]) > int(AUG_indexes_2[i])+RBS_window):
            pass
        if int(l[1]) != 0 and int(l[0]) < int(l[1]) and (int(l[0]) < int(AUG_indexes_2[i])-RBS_window)                                                    and     (int(l[1]) >= int(AUG_indexes_2[i])-RBS_window and int(l[1]) <= int(AUG_indexes_2[i])+RBS_window):
            fields2[i][k] = "x"
        if int(l[1]) != 0 and int(l[0]) < int(l[1]) and (int(l[0]) >= int(AUG_indexes_2[i])-RBS_window and int(l[0]) <= int(AUG_indexes_2[i])+RBS_window)   and     (int(l[1]) >= int(AUG_indexes_2[i])-RBS_window or int(l[1]) <= int(AUG_indexes_2[i])+RBS_window): # no need of second condition
            fields2[i][k] = "x"
        if int(l[1]) != 0 and int(l[0]) < int(l[1]) and (int(l[0]) > int(AUG_indexes_2[i])+RBS_window)                                                    and     (int(l[1]) > int(AUG_indexes_2[i])+RBS_window):                                            # no need of second condition
            pass

        if int(l[1]) != 0 and int(l[0]) > int(l[1]) and (int(l[1]) < int(AUG_indexes_2[i])-RBS_window)                                                    and     (int(l[0]) < int(AUG_indexes_2[i])-RBS_window or int(l[0]) > int(AUG_indexes_2[i])+RBS_window):
            pass
        if int(l[1]) != 0 and int(l[0]) > int(l[1]) and (int(l[1]) < int(AUG_indexes_2[i])-RBS_window)                                                    and     (int(l[0]) >= int(AUG_indexes_2[i])-RBS_window and int(l[0]) <= int(AUG_indexes_2[i])+RBS_window):
            fields2[i][k] = "x"
        if int(l[1]) != 0 and int(l[0]) > int(l[1]) and (int(l[1]) >= int(AUG_indexes_2[i])-RBS_window and int(l[1]) <= int(AUG_indexes_2[i])+RBS_window)   and     (int(l[0]) >= int(AUG_indexes_2[i])-RBS_window or int(l[0]) <= int(AUG_indexes_2[i])+RBS_window): # no need of second condition
            fields2[i][k] = "x"
        if int(l[1]) != 0 and int(l[0]) > int(l[1]) and (int(l[1]) > int(AUG_indexes_2[i])+RBS_window)                                                    and     (int(l[0]) > int(AUG_indexes_2[i])+RBS_window):                                            # no need of second condition
            pass
