...
#pipeline
#--------------------------------------------------------------------------------------------------------------------
python3 1_a_TIR_mutations.py $var1 $var2 $var4
...
python3 1_b_generating_seqs_file.py >seqs_file.txt

python3 1_c_generating_start_sites_file.py >start_sites_file.txt

RNAfold --temp $var3 <seqs_file.txt >2_sequences_vienna_output.txt

python3 2_dot_bracket_format.py seqs_file.txt >2_dot_bracket_format.txt #this not be used if running fold command
...
python3 3_dGunfold.py start_sites_file.txt seqs_file.txt >3_sequences_with_constraint.txt

RNAfold --temp $var3 -C <3_sequences_with_constraint.txt >4_sequences_with_constraint_vienna_output.txt

python3 4_calculate_ddG.py >final.txt
