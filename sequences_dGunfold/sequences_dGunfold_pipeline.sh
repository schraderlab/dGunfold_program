...
#pipeline
#--------------------------------------------------------------------------------------------------------------------
python3 1_retrieving_sequences.py $var1 $var2 $var4 >1_list_of_sequences.txt
...
#
python3 2_dot_bracket_format.py 1_list_of_sequences.txt >2_dot_bracket_format.txt #this not be used if running fold command
...
python3 3_dGunfold.py >3_sequences_with_constraint.txt
